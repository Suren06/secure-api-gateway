package com.secureapigateway.filter;

import com.secureapigateway.config.RedisHashComponent;
import com.secureapigateway.dto.ApiKey;
import com.secureapigateway.util.AppConstants;
...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if(routeId == null || CollectionUtils.isEmpty(apiKeyHeader) || !isAuthorize(routeId, apiKeyHeader.get(0))){
            throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "Not a valid apiKey");
        }
